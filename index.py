...
st.title("📚 Student Study Plan and Timetable Generator")
st.subheader("Welcome to the Study Plan & Timetable Generator!")
st.write("""
This tool helps students organize their study time more effectively by generating customized study plans.
You can:
- Add new student data to track their performance.
- Fetch existing data to create a tailored study plan.
- Generate a detailed weekly study timetable based on subjects and marks.
- Get a daily breakdown of study sessions for optimal time management.

Use the options below to navigate and get started!
""")
...
option = st.radio(
    "Choose an action:",
    ["Add Student Data", "Fetch Student Study Plan and Generate Timetable", "Learn More About This App"],
    key="home_option"
)

# Redirect to respective functionalities based on user choice
if option == "Add Student Data":
    st.write("### Add Student Data")
    st.write("Navigate to the section for adding student data and enter the required information.")

elif option == "Fetch Student Study Plan and Generate Timetable":
    st.write("### Fetch Study Plan")
    st.write("Input a student's ID to retrieve their data and generate a tailored study timetable.")

elif option == "Learn More About This App":
    st.write("### About the Study Plan & Timetable Generator")
    st.write("""
    This app is designed to help students improve their study habits by providing a structured study plan.
    It uses data such as student marks, attendance, and available study hours to suggest a balanced timetable.
    Each study plan aims to focus more time on subjects where the student needs improvement, ensuring effective learning.
    
    Whether you're a student looking to manage your time better, or a teacher seeking to help your students, this app is here to assist you!
    """)
